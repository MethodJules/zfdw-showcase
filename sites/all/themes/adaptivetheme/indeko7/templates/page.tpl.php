...
<div id="page-wrapper">
  ...
  <div class="zsb-container zfdw-container">
    <div class="navbar-brand">
      <a href="https://www.uni-hildesheim.de/">
        <img class="logo-main" src="<?php print base_path() . drupal_get_path('theme', 'indeko7')?>/images/logo-uni.png" alt="Logo der Stiftung Universität Hildesheim">
      </a>
    </div>
  </div>
  ...
  <div class="brand-border">
    <ul class="zsb-container">
      <li class="home"><a href="https://www.uni-hildesheim.de/zfdw/"><span class="sr-only">Zur Homepage</span><span class="icon-home" aria-hidden="true"></span></a></li>
      <li class="first-brand onlyinst"><a href="https://www.uni-hildesheim.de/zfdw/">Zentrum für Digitalen Wandel / Center for Digital Change</a></li>
    </ul>
